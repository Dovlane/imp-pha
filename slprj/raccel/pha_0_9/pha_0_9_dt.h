...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . m0za0b3lr2 ) , 0 , 0 , 269 }
, { ( char_T * ) ( & rtDW . jyvbb3c21t [ 0 ] ) , 0 , 0 , 18 } , { ( char_T *
) ( & rtDW . f3biyympth . TUbufferPtrs [ 0 ] ) , 11 , 0 , 28 } , { ( char_T *
) ( & rtDW . ngat1pyozl . Tail ) , 10 , 0 , 73 } , { ( char_T * ) ( & rtDW .
omis1sz1c1 ) , 6 , 0 , 1 } , { ( char_T * ) ( & rtDW . pka2kvd4xr ) , 8 , 0 ,
6 } } ; static DataTypeTransitionTable rtBTransTable = { 6U , rtBTransitions
} ; static DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP .
PIDController_D ) , 0 , 0 , 69 } } ; static DataTypeTransitionTable
