...
int32_T pha_0_9_111da520_1_ds_obs_il ( const NeDynamicSystem * LC , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { static boolean_T
_cg_const_1 [ 755 ] = { true , true , true , true , true , true , true , true
...
true , true , true , true , true , true , true , true , true , true , true ,
true , true , true } ; PmBoolVector out ; int32_T b ; boolean_T t0 [ 755 ] ;
( void ) t1 ; ( void ) LC ; out = t2 -> mOBS_IL ; for ( b = 0 ; b < 755 ; b
++ ) { t0 [ b ] = _cg_const_1 [ b ] ; } for ( b = 0 ; b < 755 ; b ++ ) { out
