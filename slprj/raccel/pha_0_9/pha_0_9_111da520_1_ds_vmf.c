...
int32_T pha_0_9_111da520_1_ds_vmf ( const NeDynamicSystem * LC , const
NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { static boolean_T
_cg_const_1 [ 126 ] = { false , true , true , false , true , true , false ,
...
true , true , true , true , true , true , true , true , true , true , true ,
false , false } ; PmBoolVector out ; int32_T b ; boolean_T t0 [ 126 ] ; (
void ) t1 ; ( void ) LC ; out = t2 -> mVMF ; for ( b = 0 ; b < 126 ; b ++ ) {
t0 [ b ] = _cg_const_1 [ b ] ; } for ( b = 0 ; b < 126 ; b ++ ) { out . mX [
