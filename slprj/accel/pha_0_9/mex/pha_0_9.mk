...
MODEL                = pha_0_9
MODULES              = pha_0_9_acc.c pha_0_9_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c c_mexapi_version.c lccstub.c
PRODUCT              = $(RELATIVE_PATH_TO_ANCHOR)/pha_0_9_acc.mexw64
MAKEFILE             = pha_0_9.mk
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/accel/pha_0_9 \
...
pha_0_9_acc.obj : $(START_DIR)/slprj/accel/pha_0_9/pha_0_9_acc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/pha_0_9/pha_0_9_acc.c

pha_0_9_acc_data.obj : $(START_DIR)/slprj/accel/pha_0_9/pha_0_9_acc_data.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/pha_0_9/pha_0_9_acc_data.c

rtGetInf.obj : $(START_DIR)/slprj/accel/pha_0_9/rtGetInf.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/pha_0_9/rtGetInf.c

rtGetNaN.obj : $(START_DIR)/slprj/accel/pha_0_9/rtGetNaN.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/pha_0_9/rtGetNaN.c

rt_nonfinite.obj : $(START_DIR)/slprj/accel/pha_0_9/rt_nonfinite.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(START_DIR)/slprj/accel/pha_0_9/rt_nonfinite.c
